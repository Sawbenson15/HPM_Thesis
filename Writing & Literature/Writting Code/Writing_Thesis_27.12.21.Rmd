...
<center>
![](/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/Results/Corona_General/Infect_combined.png){width=99%}
</center>
...
p1 <- ggdraw() + draw_image("/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/PDP_Example.png", scale = 1)
p2 <- ggdraw() + draw_image("/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/ICE_Example.png", scale = 1)
p3 <- ggdraw() + draw_image("/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/heat_test.png", scale = 1)
p4 <- ggdraw() + draw_image("/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/3D_Example.png", scale = 1)
...
> **Hypothesis III:** The Covid-19 crisis impacted properties in the top 25th percentile of price more than the bottom 25th percentile 
>
...
> **Hypothesis III:** The Covid-19 crisis increased the premium for property size 
>
...
> **Hypothesis V:** The Covid-19 crisis increased the premium for property age 
>
...
> **Hypothesis VI:** The Covid-19 crisis impacted properties in the top 25th percentile of age more than the bottom 25th percentile  
>
...
> **Hypothesis V:** The Covid-19 crisis significantly impacted the premium for days on market 
>
...
> **Hypothesis III:** The Covid-19 crisis impacted properties in the top 25th percentile of days on market more than the bottom 25th percentile 
>
...
### 6. Results
There will be a clear and consistant structure for each subsection of results. Each hypothesis will have: 

* A *general overview* of the characteristic being modeled
  + This is to give the reader a clear understanding of the feature being modeled in terms of frequency, central tendency, and key relationships to time, infection rates, and other features wich may be relevant
* Model results with standard hypothesis conclusion(s) 
...
p1 <- ggdraw() + draw_image("/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/Results/Corona_General/Waves_of_infection.png", scale = 1)
p2 <- ggdraw() + draw_image("/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/Results/Corona_General/Accumulation_of_infections.png", scale = 1)
p3 <- ggdraw() + draw_image("/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/Results/Corona_General/Infections_and_Price.png", scale = 1)
p4 <- ggdraw() + draw_image("/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/Results/Corona_General/Infection_period_price_dist_.png", scale = 1)
...
#### 6.4 Covid-19: Premium for Relative Price Levels 
#### 6.5 Covid-19: Premium for Size
#### 6.6 Covid-19: Premium for Age 
#### 6.7 Covid-19: Change in Days on Market
