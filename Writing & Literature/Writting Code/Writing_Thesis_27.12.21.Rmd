...
<center>
![](/Users/sawyerbenson/Documents/Master Thesis/HPM_Thesis/Writing & Literature/Graphics from pptx/Index.png){width=90%}
</center>
...
> **Hypothesis V:** The Covid-19 crisis impacted properties in the top 25th percentile of price more than the bottom 25th percentile 
>
...
> **Hypothesis VI:** The Covid-19 crisis increased the premium for property age 
>
...
> **Hypothesis VIII:** The Covid-19 crisis significantly impacted the premium for days on market 
>
...
### 6. Results
This section will follow a clear and consistent structure for each set of results. Each hypothesis will have: A *summary of the finding*; *feature review* of the characteristic being modeled; and *model results* from the OLS and ML models with standard hypothesis conclusion(s). 
...
The PDP shows that on average, an increase in price at every level of daily infections > 0 reduces test MSE. Furthermore, this trend is generally upward trending, with a notable range of response between 1,800 and 2,500 infections, which I refer to as the *infections-price ridge.* Discussions regarding possible explanations for the general shape of this region will be explored in section 7.     
...
Foreword for this section: There are two contextual details which must be considered for one to appropriatly interpret the following findings. First, the variables for total number bedrooms and the total living area of a home are highly correlated, and therefore when total living area is included, the beta coefficients for each level of bedroom represents only the premium homeowners are willing to pay for the actual feature of an extra bedroom at a fixed living area, and not the extra living area itself. As this results in convoluted results, living area is excluded when testing the effect of bedrooms. This effectivly measures the additional room and the average addition of living area associated with that additional room. Secondly, the OLS results listed below represent the change in the beta coefficients from post and pre corona, not the absolute effect, as in the case of measuring daily infection alone. 

##### 6.2.1 Summary of Findings
> Prelimilary finding show that the price distribution for every level of number of bedrooms increased after the beginning of the infection period (i.e. accumulation of infections >= 1000), as predicted. The average number of total bedrooms between pre and post-infections period are effectivly equal, with post-infections period being 0.003 higher. However, the key finding is in the change in premium for each level of number of bedrooms.    
>
> The fully controled Alpha model results show that the everage premium for each level of number of bedrooms significantly increased in response to increases in daily infections. Every increase found is at least significant at the p < 0.05 level except for single bedroom homes. Therefore, I reject the $H_0:$ of hypothesis II and conclude that the Covid-19 crisis significantly increased demand-premiums for every level of bedrooms. Possible theories regarding this significant shift in premiums is explored in section 7.
